...
class FrontController
{
    ...
    public static function logger(){
        $userLogger =  new Monolog\Logger('user_logger');

        $userLogger->pushHandler(new Monolog\Handler\StreamHandler("../storage/logs/userLogs"));
        $userLogger->pushHandler(new Monolog\Handler\FirePHPHandler());
...
//    $viewargs['userLogger'] =  FrontController::logger();
